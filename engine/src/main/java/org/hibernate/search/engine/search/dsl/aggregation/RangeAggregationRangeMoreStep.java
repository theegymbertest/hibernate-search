...
public interface RangeAggregationRangeMoreStep<
				S extends RangeAggregationRangeMoreStep<? extends S, ? extends N, F>,
				N extends RangeAggregationOptionsStep<? extends N, F, Map<Range<F>, Integer>>,
				F
		>
		extends RangeAggregationOptionsStep<N, F, Map<Range<F>, Integer>>,
