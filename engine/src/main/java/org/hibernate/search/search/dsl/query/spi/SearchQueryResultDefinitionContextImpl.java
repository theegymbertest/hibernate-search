 ...
 */
package org.hibernate.search.search.dsl.query.spi;
...
import org.hibernate.search.search.dsl.query.SearchQueryWrappingDefinitionResultContext;
import org.hibernate.search.search.dsl.query.impl.SearchQueryWrappingDefinitionResultContextImpl;
import org.hibernate.search.search.dsl.spi.SearchTargetContext;
import org.hibernate.search.search.query.spi.HitAggregator;
import org.hibernate.search.search.query.spi.LoadingHitCollector;
import org.hibernate.search.search.query.impl.ObjectHitAggregator;
import org.hibernate.search.search.query.impl.ProjectionHitAggregator;
...
import org.hibernate.search.search.query.spi.SearchQueryBuilder;
import org.hibernate.search.search.query.impl.ReferenceHitAggregator;
