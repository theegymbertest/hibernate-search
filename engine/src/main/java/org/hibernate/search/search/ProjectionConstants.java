 ...
 */
package org.hibernate.search.search;
...
public final class ProjectionConstants {
	 ...
	 * for your query query: an {@link org.hibernate.search.backend.index.spi.IndexManager}
	 * may return a Java representation of the document,
	 * but a {@link org.hibernate.search.engine.SearchManager} will
	 ...
	 * but a {@link org.hibernate.search.engine.SearchManager} may
