...
The `org.hibernate.search.annotations.DynamicBoost` is not (and cannot be) supported with Elasticsearch, because the platform lacks per-document, index-time boosting capabilities. Static boost (`@Boost`) is, however, supported.
