...
public class SingleFieldIndexBinding extends AbstractObjectBinding {
	...
	public static final Consumer<IndexFieldTypeOptionsStep<?, ?>> NO_ADDITIONAL_CONFIGURATION = c -> {};

	public static <S extends IndexFieldTypeOptionsStep<?, ?>> SingleFieldIndexBinding create(IndexSchemaElement root,
	...
	public static <S extends IndexFieldTypeOptionsStep<?, ?>> SingleFieldIndexBinding createWithSingleValuedNestedFields(
	...
	private <S extends IndexFieldTypeOptionsStep<?, ?>> SingleFieldIndexBinding(
