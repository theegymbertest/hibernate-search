...
public class SimpleFieldModelsByType {
	...
	@SuppressWarnings("unchecked")
	private static <F, S extends SearchableProjectableIndexFieldTypeOptionsStep<?, ?>> SimpleFieldModel<?> mapMultiValued(
			FieldTypeDescriptor<F, ?> typeDescriptor, IndexSchemaElement parent, String prefix,
			Consumer<? super S>[] additionalConfiguration) {
