...
public final class SimpleFieldMapper<F, S extends IndexFieldTypeOptionsStep<?, F>, M> {

	public static <F, S extends IndexFieldTypeOptionsStep<?, F>, M> SimpleFieldMapper<F, S, M> of(
	...
	public static <F, S extends IndexFieldTypeOptionsStep<?, F>> SimpleFieldMapper<F, S, IndexFieldReference<F>> of(
			Function<IndexFieldTypeFactory, S> initialConfiguration,
