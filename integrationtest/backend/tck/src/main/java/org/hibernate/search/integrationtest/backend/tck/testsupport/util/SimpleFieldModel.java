...
public class SimpleFieldModel<F> {
	...
	public static <F, S extends IndexFieldTypeOptionsStep<?, F>> SimpleFieldMapper<F, S, SimpleFieldModel<F>> mapper(
	...
	public static <
			F,
			S extends IndexFieldTypeOptionsStep<?, F>> SimpleFieldMapper<F, S, SimpleFieldModel<F>> mapperWithOverride(
					FieldTypeDescriptor<F, S> typeDescriptor,
