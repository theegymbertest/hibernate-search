...
public class SecondLevelObjectBinding extends AbstractObjectBinding {
	...
	public static <S extends IndexFieldTypeOptionsStep<?, ?>> SecondLevelObjectBinding create(
	...
	<S extends IndexFieldTypeOptionsStep<?, ?>> SecondLevelObjectBinding(AbstractObjectBinding parentBinding,
