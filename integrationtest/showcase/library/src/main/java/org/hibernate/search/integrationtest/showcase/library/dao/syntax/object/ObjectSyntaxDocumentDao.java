...
import org.hibernate.search.entity.orm.jpa.FullTextQuery;
import org.hibernate.search.entity.orm.jpa.FullTextSearchTarget;
...
import org.hibernate.search.search.dsl.predicate.BooleanJunctionPredicateContext;
...
class ObjectSyntaxDocumentDao extends DocumentDao {
	...
	public Optional<Book> getByIsbn(String isbnAsString) {
		...
		org.hibernate.search.entity.orm.hibernate.FullTextSearchTarget<Book> target =
				fullTextSession.search( Book.class );

		org.hibernate.search.entity.orm.hibernate.FullTextQuery<Book> query = target.query()
				.asEntities()
				.predicate(
