...
/**
 * This integration test compares the performance between the existing mass-indexer and the new mass-indexing batch job,
 * introduced by the integration of JSR 352.
 *
