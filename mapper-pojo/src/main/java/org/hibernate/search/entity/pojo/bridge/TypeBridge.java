 ...
 */
package org.hibernate.search.entity.pojo.bridge;
...
public interface TypeBridge extends AutoCloseable {
	 ...
	 * {@link org.hibernate.search.backend.document.IndexFieldAccessor}s retrieved when the
	 ...
	 * {@link org.hibernate.search.entity.pojo.model.PojoModelElementAccessor}s retrieved when the
	 * {@link #bind(IndexSchemaElement, PojoModelType, SearchModel)} method was called.
	 *
