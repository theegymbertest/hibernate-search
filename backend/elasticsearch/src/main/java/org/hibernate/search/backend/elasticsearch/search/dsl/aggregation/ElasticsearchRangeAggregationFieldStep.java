...
public interface ElasticsearchRangeAggregationFieldStep
		extends RangeAggregationFieldStep {

	@Override
	<F> RangeAggregationRangeStep<ElasticsearchRangeAggregationRangeMoreStep<F>, F> field(
			String absoluteFieldPath, Class<F> type);

	@Override
	<F> RangeAggregationRangeStep<ElasticsearchRangeAggregationRangeMoreStep<F>, F> field(
			String absoluteFieldPath, Class<F> type, ProjectionConverter projectionConverter);
}
