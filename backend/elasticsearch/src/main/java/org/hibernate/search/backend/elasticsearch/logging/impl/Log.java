...
public interface Log extends BasicLogger {
	...
	@Message(id = ID_OFFSET + 173, value = "The targeted Elasticsearch cluster is reachable, but does not expose its version."
			...
			+ " If you are targeting AWS OpenSearch Serverless, you must set the configuration property '%1$s' explicitly to '%2$s'."
	...
	@Message(id = ID_OFFSET + 175,
			value = "Unexpected AWS OpenSearch Serverless version: '%1$s'."
					+ " AWS OpenSearch Serverless doesn't have version numbers."
	...
	@Message(id = ID_OFFSET + 176, value = "Cannot execute '%s' because Amazon OpenSearch Service does not support this operation."
			+ " Either avoid this operation or switch to another Elasticsearch/OpenSearch distribution.")
	SearchException cannotExecuteOperationOnAmazonOpenSearchServerless(String flush);
