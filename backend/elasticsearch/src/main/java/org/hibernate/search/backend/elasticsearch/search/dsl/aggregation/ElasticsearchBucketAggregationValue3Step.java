...
/**
 * The step in a bucket aggregation definition where the third per-bucket value can be set,
 ...
 */
public interface ElasticsearchBucketAggregationValue3Step<K, M, V1, V2>
	 ...
	 */
	<V> AggregationFinalStep<Map<K, V>> transform(BiFunction<V1, V2, V> transformer);

	@Override
	<V3> ElasticsearchBucketAggregationValue4Step<K, M, V1, V2, V3> add(SearchAggregation<V3> subAggregation);

	@Override
	<V3> ElasticsearchBucketAggregationValue4Step<K, M, V1, V2, V3> add(AggregationFinalStep<V3> subAggregation);

	@Override
	ElasticsearchBucketAggregationValue4Step<K, M, V1, V2, Integer> addDocumentCount();

	@Override
	ElasticsearchBucketAggregationValue4Step<K, M, V1, V2, M> addMetadata();
