 ...
 */
package org.hibernate.search.entity.orm.model.impl;
...
import org.hibernate.search.entity.orm.util.impl.XClassOrdering;
import org.hibernate.search.entity.pojo.model.spi.GenericContextAwarePojoGenericTypeModel.RawTypeDeclaringContext;
...
import org.hibernate.search.entity.pojo.util.spi.AnnotationHelper;
...
public class HibernateOrmBootstrapIntrospector implements PojoBootstrapIntrospector {
	 ...
	 * which lowers the risk of generating duplicate {@link org.hibernate.search.entity.pojo.model.spi.PropertyHandle}s.
	 * <p>
