...
/**
 * An adapter from the {@link org.hibernate.search.entity.orm.spi.BeanResolver} interface
 * to {@link org.hibernate.search.engine.spi.BeanResolver}.
 */
final class DelegatingBeanResolver implements BeanResolver {

	private final org.hibernate.search.entity.orm.spi.BeanResolver hibernateOrmBeanResolver;

	public DelegatingBeanResolver(org.hibernate.search.entity.orm.spi.BeanResolver hibernateOrmBeanResolver) {
