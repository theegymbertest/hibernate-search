 ...
 * {@link org.hibernate.search.mapper.pojo.bridge.ObjectBridge#write(DocumentElement, Object, ObjectBridgeWriteContext)}.
 */
public interface ObjectBridgeWriteContext {
	 ...
	 */
	<T> T extension(ObjectBridgeWriteContextExtension<T> extension);
