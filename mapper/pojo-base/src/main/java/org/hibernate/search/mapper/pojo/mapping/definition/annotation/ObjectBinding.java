...
import org.hibernate.search.mapper.pojo.mapping.definition.annotation.processing.impl.ObjectBindingProcessor;
...
@Repeatable(ObjectBinding.List.class)
@TypeMapping(processor = @TypeMappingAnnotationProcessorRef(type = ObjectBindingProcessor.class, retrieval = BeanRetrieval.CONSTRUCTOR))
