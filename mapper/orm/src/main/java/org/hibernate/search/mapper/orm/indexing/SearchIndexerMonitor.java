...
/**
 * As {@link SearchIndexer#reindex()} can take some time to finish its job,
 * a SearchIndexerMonitor can be defined to track indexing performance.
 * <p>
 ...
 */
public interface SearchIndexerMonitor {
